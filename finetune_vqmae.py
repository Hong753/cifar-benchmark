...
from models.vqvit import ViT_Tiny
...
def run(data_dir, device_list, batch_size, warmup_epochs, num_epochs):
    ...
    pretrain_ckpt = torch.load("./checkpoints/pretrain_vqmae_down2_patch2_32.pth", map_location="cpu")["model_state_dict"]
    ...
    with tqdm(range(num_epochs), leave=True) as pbar:
        for epoch in pbar:
            ...
            if acc > best_acc:
                ...
                torch.save(checkpoint, "./checkpoints/finetune_vqmae_down2_patch2_32.pth")
