# References: https://github.com/state-spaces/mamba/tree/main
...
#         y = selective_scan_fn(x, Δ, A, B, C, D) # CUDA
...
# class Block(nn.Module):
#     def __init__(self, dim, mixer_cls, norm_cls=nn.LayerNorm, fused_add_norm=True, residual_in_fp32=False, drop_path=0.0):
#         super().__init__()
